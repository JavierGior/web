    ...
    XFs4: function (e, t, i) {
            ...
            S = function (e) {
                ...
                return Object(a.c)(t, e), t.prototype.applyInternalDefaults = function () {
                    ...
                    var p = Math.min(t.innerWidth / i.width, t.innerHeight / i.height),
                        ...
                        y = this.startAngle,
                        f = this.endAngle;
                    this._pixelInnerRadius = C.relativeRadiusToValue(s, g), this._bulletMask.path = h.arc(y, f - y, g, this._pixelInnerRadius), k.each(this.xAxes.iterator(), function (e) {
        ...
        var Z = i("VIOb"),
            ...
            re = function (e) {
                function t() {
                    var t = e.call(this) || this;
                    return t.legendSettings = new ae.c, t.className = "FlowDiagramNode", t.isMeasured = !1, new w.a, t.draggable = !0, t.inert = !0, t.setStateOnChildren = !0, t.events.on("positionchanged", t.invalidateLinks, t, !1), t.events.on("sizechanged", t.invalidateLinks, t, !1), t
                }
                    ...
                    if (!this.preventShow) {
                        if (this.interpolationDuration > 0) {
                            ...
                            k.each(this.links.iterator(), function (e) {
                                ...
                                i.sequencedInterpolation && (o = i.sequencedInterpolationDelay * a + s * a / k.length(i.nodes.iterator())), r.opacity = 0, r.invalidateLinks(), r.animate([{
                                    property: "opacity",
                                    from: 0,
                                    to: 1
                                }, {
            ...
            Ye = function (e) {
                ...
                return Object(a.c)(t, e), Object.defineProperty(t.prototype, "navigationBar", {
                    ...
                    if (!e.series) {
                        ...
                        i.level = a;
                        var r = e.dataContext;
                        r && (i.config = r.config), this.dataUsers.removeValue(i), i.data = e.children.values, i.fill = e.color, i.columnsContainer.hide(0), i.bulletsContainer.hide(0), i.columns.template.adapter.add("fill", function (e, t) {
                            var i = t.dataItem;
                            if (i) {
                    ...
                    for (var t, i = e.x0, n = e.x1, a = e.y0, r = e.y1, o = e.children, s = -1, l = o.length, u = e.value && (r - a) / e.value; ++s < l;)(t = o.getIndex(s)).x0 = i, t.x1 = n, t.y0 = a, a += t.value * u, t.y1 = a
                }, t.prototype.dice = function (e) {
                    for (var t, i = e.x0, n = e.x1, a = e.y0, r = e.y1, o = e.children, s = -1, l = o.length, u = e.value && (n - i) / e.value; ++s < l;)(t = o.getIndex(s)).y0 = a, t.y1 = r, t.x0 = i, i += t.value * u, t.x1 = i
        ...
        var qe = function (e) {
            ...
            Ke = function (e) {
                ...
                return Object(a.c)(t, e), t.prototype.updateSeriesMasks = function () {
                    ...
                    this.chartContainer.paddingTop = -this.dy3D, this.chartContainer.paddingRight = this.dx3D, this.scrollbarX && (this.scrollbarX.dy = this.dy3D, this.scrollbarX.dx = this.dx3D), this.scrollbarY && (this.scrollbarY.dy = this.dy3D, this.scrollbarY.dx = this.dx3D), this.fixColumns(), e.prototype.fixLayout.call(this)
                ...
                return Object(a.c)(t, e), t.prototype.draw = function () {
                    ...
                    if ("vertical" == this.orientation) {
                        var u = {
                            ...
                            f = h.lineTo(p),
                            m = h.lineTo(u);
                        0 != s && (f = h.quadraticCurveTo(p, g), m = h.quadraticCurveTo(u, y)), l = h.moveTo(u) + h.lineTo(c) + f + h.lineTo(d) + m, this.tickPoint = {
                            x: c.x + (p.x - c.x) / 2,
                            y: c.y + (p.y - c.y) / 2
                        }
                    } else {
                        ...
                        0 != s && (f = h.quadraticCurveTo(A, g), m = h.quadraticCurveTo(P, y)), l = h.moveTo(P) + h.lineTo(b) + f + h.lineTo(I) + m, this.tickPoint = {
                            y: P.y + (I.y - P.y) / 2,
                            x: P.x + (I.x - P.x) / 2
                        }
                    }
